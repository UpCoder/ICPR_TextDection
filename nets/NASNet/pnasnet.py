...
def _build_pnasnet_base(images,
  ...
  print('reduction_indices: ', reduction_indices)
  # pylint: disable=protected-access
  stem = lambda: nasnet._imagenet_stem(images, hparams, normal_cell)
  # pylint: enable=protected-access
  net, cell_outputs = stem()
  end_points['scale-1'] = cell_outputs[1]
  end_points['scale-2'] = cell_outputs[2]
  end_points['scale-3'] = cell_outputs[3]
  ...
  true_cell_num = 2
  print('hparams.num_cells is ', hparams.num_cells)
